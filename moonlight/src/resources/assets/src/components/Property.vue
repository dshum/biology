<template>
  ...
  <div v-else-if="className === 'ManyToManyProperty'">
    <manytomany-property v-on:update="update(arguments[0])" :className="className" :mode="mode" :view="view"></manytomany-property>
  </div>
